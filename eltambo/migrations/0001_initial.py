# Generated by Django 2.0.7 on 2018-07-18 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caratteristiche', models.CharField(choices=[('1', 'Nuovo'), ('2', 'Usato'), ('3', 'Nuovo-scontato'), ('4', 'Usato-scontato')], max_length=5)),
                ('acquistato', models.ManyToManyField(through='eltambo.Acquista', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='acquista',
        ...
        migrations.AddField(
            model_name='utente',
            name='indirizzo',
            field=models.ManyToManyField(to='eltambo.Indirizzo'),
        ),
        migrations.AddField(
            model_name='utente',
